...
void First()
{
    string Deg;
    double Rad;
    cout << "Please enter angle (from 0 to 360)\n";
    cin >> Deg;
    if ((stod(Deg) > 360) or (stod(Deg) < 0))
    {
        cout << "Incorrect angle\n";
    }
    else
    {
        Rad = stod(Deg) / 180;
...
void Second()
{
    string Rad;
    double Deg;
    cout << "Please enter radians (from 0 to 2)\n";
    cin >> Rad;
...
void Third()
{
    ...
    cout << "Enter starting weight of sweets (X)\n";
    cin >> X;
...
void Fourth()
{
    ...
    cout << "Now distance between cars is " << dist << endl;
