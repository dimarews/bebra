...
int main()
{
    while (true) {
        ...
        cout << "Choose number of exercise (enter 0 to exit)\n"
            ...
            << "6) A is known. Calculate A ^ 8 using an auxiliary variable and three multiplications.\n"
            << "7) A is known. Calculate A ^ 15 using two auxiliary variables and five multiplications.\n";
        cin >> ExNum;
        if (ExNum == 1)
        {
            First();
